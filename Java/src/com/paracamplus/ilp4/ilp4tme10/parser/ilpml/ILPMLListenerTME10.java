...
public class ILPMLListenerTME10 implements ILPMLgrammar4tme10Listener {
	
	protected IASTfactoryTME10 factory;
	
	public ILPMLListenerTME10(IASTfactoryTME10 factory) {
		super();
