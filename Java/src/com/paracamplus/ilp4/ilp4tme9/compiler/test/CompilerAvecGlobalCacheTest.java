...
import com.paracamplus.ilp4.ilp4tme9.compiler.CompilerAvecGlobalCache;
...
public class CompilerAvecGlobalCacheTest extends com.paracamplus.ilp4.compiler.test.CompilerTest {
    ...
    public CompilerAvecGlobalCacheTest(final File file) {
        super(file);
    }
    ...
    public void configureRunner(CompilerRunner run) throws CompilationException {
        ...
        CompilerAvecGlobalCache compiler = new CompilerAvecGlobalCache(ioe, gve);
