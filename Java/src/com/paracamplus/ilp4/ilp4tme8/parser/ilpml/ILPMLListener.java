...
public class ILPMLListener implements ILPMLgrammar4tme8Listener {
    protected IASTfactoryTME8 factory;

	public ILPMLListener(IASTfactoryTME8 factory) {
		super();
    ...
    public void exitHasProperty(HasPropertyContext ctx) {
        ctx.node = factory.newHasProperty(ctx.property.node, ctx.obj.node);
    }
    ...
    public void exitWriteProperty(WritePropertyContext ctx) {
        ctx.node = factory.newWriteProperty(ctx.property.node, ctx.obj.node, ctx.val.node);
    }
    ...
    public void exitReadProperty(ReadPropertyContext ctx) {
        ctx.node = factory.newReadProperty(ctx.property.node, ctx.obj.node);
    }
